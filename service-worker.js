const CACHE_NAME = 'cache-v26'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v26',
    'estilos/styles.css?v26',
    'estilos/mediaQueries.css?v26',
    'javascript/script.js?v26',
